...
local walkSlider = createSlider(movePage, "Vitesse marche", 234, 16, 250, 16, function(v)
...
-- Zone de drag complète sur tout le header
local dragOverlay = Instance.new("TextButton")
dragOverlay.Name = "DragOverlay"
dragOverlay.Size = UDim2.new(1, 0, 0, 28)
dragOverlay.BackgroundTransparency = 1
dragOverlay.Text = ""
dragOverlay.ZIndex = 121
dragOverlay.Parent = clickControl
