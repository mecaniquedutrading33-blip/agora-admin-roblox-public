...
local selectCar -- forward declaration (défini plus bas, utilisé par refreshVehicleList)
...
local function refreshVehicleList()
	...
	for name, info in pairs(VEHICLE_DATA) do
		...
		if iid then
			itemImg.Image = "http://www.roblox.com/Thumbs/Asset.ashx?width=100&height=100&assetId=" .. iid
		end
